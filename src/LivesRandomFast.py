...
from NetworkNorm import NetworkNorm
...
net = NetworkNorm(action_space, action_space, obs_space,obs, 1, "dObs", True)

b = '%d' % int(best.getBest())
#b = "310"

NetworkNorm.loadWeightsFromDisk(exercise+ "/weights/" + b)
...
def saveBestStuff():
    ...
    best.save()
    b = '%d'%int(bestReward)
    NetworkNorm.saveWeightsToDisk(exercise+ "/weights/" + b)
