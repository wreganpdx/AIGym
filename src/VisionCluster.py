...
from NetworkCluster import NetworkCluster
...
net = NetworkCluster(action_space, action_space, obs_space,obs, 1, "dObs", True)
NetworkCluster.setClassLabels(env.unwrapped.get_action_meanings())
b = '%.4f' % best.getBest()
#b = "310"
NetworkCluster.loadWeightsFromDisk(exercise+ "/weights/" + b)
NetworkCluster.setPath(exercise+ "/weights/")
NetworkCluster.setScoreObj(best)
env.reset()
